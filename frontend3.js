	...
	*/
	...
	function u(e) {
		if (i(), l && e) {
			...
			// Bungkus URL dengan player API
			if (!e.startsWith("https://api.exthem.es/player.php?url=")) {
				e = "https://api.exthem.es/player.php?url=" + encodeURIComponent(e);
			}

			var t = document.createElement("div");
			t.id = "famv-player-loading";
			t.className = "famv-player-loading";
			t.innerHTML = '<div class="famv-spinner-ring"><div class="famv-spinner-ring-inner"></div><div class="famv-spinner-glow"></div></div><span class="famv-loading-text">Memuat Player...</span>';

			var n = document.createElement("iframe");
			n.src = e;
			n.className = "h-full w-full border-0";
			n.setAttribute("allowfullscreen", "");
			n.setAttribute("loading", "lazy");
			n.style.display = "none";

			n.addEventListener("load", function () {
				var loading = document.getElementById("famv-player-loading");
